...
"""
    rain_attenuation(lat, frequency, elevation, unavailability, station_height, rain_height, R001, tilt_angle)
Compute the rain attenuation [dB] exceeded for a certaing percentage `unavailability` of time as per ITU-R P. 839-4
